...
public class Code extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        gauge3.setTitle("Potentiometer 2");
        gauge3.setMinValue(0.00);
        gauge3.setMaxValue(1023.00);
        gauge3.setMaxHeight(100000);
        gauge3.setMaxWidth(100000);
        gauge3.setSkin(new QuarterSkin(gauge3));

        gauge4.setTitle("Potentiometer 3");
        gauge4.setForegroundBaseColor(Color.RED);
        gauge4.setValueColor(Color.RED);
        gauge4.setTitleColor(Color.RED);
        gauge4.setNeedleColor(Color.RED);
        gauge4.setMinValue(0.00);
        gauge4.setMaxValue(1023.00);
        gauge4.setMaxHeight(100000);
        gauge4.setMaxWidth(100000);
        gauge4.setSkin(new QuarterSkin(gauge4));

        VBox vBox = new VBox();
        VBox vBox2 = new VBox();

        vBox.getChildren().addAll(comboBoxPorts, lineChart);
        vBox2.getChildren().addAll(comboBoxPorts, gauge, gauge2, gauge3, gauge4);
        ...
        primaryStage.setTitle("GUI Multi-Node Test (4)");
            ...
            serialPort.addEventListener((SerialPortEvent serialPortEvent) -> {
                if(serialPortEvent.isRXCHAR()){
                    try {
                        ...
                        int data3 = pot3 * (1023/255);
                        int data4 = pot4 * (1023/255);
                        ...
                        String str3 = String.valueOf(data3);
                        String str4 = String.valueOf(data4);

                        Platform.runLater(() -> {
                            gauge.setValue(Double.parseDouble(str1));
                            gauge2.setValue(Double.parseDouble(str2));
                            gauge3.setValue(Double.parseDouble(str3));
                            gauge4.setValue(Double.parseDouble(str4));
                        });
