...
public class Controller extends Application {
    ...
    public void start(Stage primaryStage) throws FileNotFoundException {
        ...
        gridpane.getColumnConstraints().addAll(column0, column1, column2, column3, column4, column5, column6, column7, column8, column9);
        gridpane.add(comboBoxPorts, 0, 0);
        gridpane.add(gauge9, 0, 1);
        gridpane.add(gauge12, 1, 1);
        gridpane.add(gauge5, 2, 1, 2, 1);
        gridpane.add(gauge6, 4, 1, 2, 1);
        gridpane.add(gauge7, 6, 1, 2, 1);
        gridpane.add(gauge8, 8, 1, 2, 1);
        gridpane.add(gauge3, 0, 2);
        gridpane.add(gauge4, 1, 2);
        gridpane.add(gauge13, 2, 2);
        gridpane.add(gauge11, 3, 2);
        gridpane.add(gauge2, 4, 2);
        gridpane.add(gauge10, 5, 2);
        gridpane.add(gauge1, 6, 2, 2, 1);
        gridpane.add(gauge14, 8, 2, 2, 1);
...
//
//                        Platform.runLater(() -> {
//                            gauge1.setValue(Double.parseDouble(str));
//                        });
                        byte[] l;

                        while (serialPort.isOpened()) {
                            l = serialPort.readBytes(10);
                            int x = l[0] & 0xFF;
                            int o = l[1] & 0xFF;
